...
Native SwiftUI menu-bar app for macOS (the Windows/Linux GUI is `gui.py` PyQt5; the macOS GUI is this app). No Dock icon (`.accessory` activation policy), dynamic status dot.
