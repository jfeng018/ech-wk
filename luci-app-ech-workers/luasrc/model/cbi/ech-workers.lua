...
-- 代理认证用户名
o = s:option(Value, "username", translate("代理认证用户名"))
o.placeholder = "可选"
o.rmempty = true
o.description = translate("本地代理认证用户名，留空则不启用认证")

-- 代理认证密码
o = s:option(Value, "password", translate("代理认证密码"))
o.password = true
o.placeholder = "可选"
o.rmempty = true
o.description = translate("本地代理认证密码（与用户名配合使用）")
...
-- 透明代理开关
o = s:option(Flag, "tproxy_enabled", translate("启用透明代理"))
o.default = 0
o.rmempty = false
o.description = translate("启用后，局域网设备无需配置即可自动使用代理（仅代理 HTTP/HTTPS 流量）")

-- tproxy 端口
o = s:option(Value, "tproxy_port", translate("透明代理端口"))
o.placeholder = "12581"
o.default = "12581"
o.rmempty = true
o.datatype = "port"
o.description = translate("透明代理监听端口，nftables 会将 80/443 端口流量重定向到此端口")
